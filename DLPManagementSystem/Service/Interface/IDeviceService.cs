...
namespace DLPManagementSystem.Service.Interface
{
    public interface IDeviceService
    {
        ...
        Task<ApiResponse<DeviceDetailDto>> UpdateDeviceAsync(Guid organizationId, Guid id, UpdateDeviceDto request, CancellationToken cancellationToken = default);

        Task<ApiResponse<bool>> DeleteDeviceAsync(Guid organizationId, Guid id, CancellationToken cancellationToken = default);
